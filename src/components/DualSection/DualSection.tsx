...
export default function DualSection(props: DualSectionProps) {
  ...
  return (
    <React.Fragment>
      <div id={title.toLowerCase()} className={`dual-section-children-container ${background}`}>
        <div className='dual-section-container full-screen-container'>
          ...
          >
            ...
            <div className='dual-section-element dual-section-content'>
              ...
              {children && (
                <button className='button dual-section-button' onClick={handleContentVisibilitySwitch}>
                  {open ? 'Close' : 'More'}
                </button>
              )}
            </div>
